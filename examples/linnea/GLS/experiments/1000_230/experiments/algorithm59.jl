...
function algorithm59(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # y: ml2, full, tmp56: ml3, full, L2: ml1, lower_triangular, W19: ml5, diagonal_vector, Z18: ml4, full
    # tmp68 = (L2^-1 y)
    stime5= time()
    trsv!('L', 'N', 'N', ml1, ml2)

    # tmp56: ml3, full, L2: ml1, lower_triangular, W19: ml5, diagonal_vector, Z18: ml4, full, tmp68: ml2, full
    # tmp71 = (L2^-T tmp68)
    stime6= time()
    trsv!('L', 'T', 'N', ml1, ml2)

    # tmp56: ml3, full, W19: ml5, diagonal_vector, Z18: ml4, full, tmp71: ml2, full
...
function write_algorithm59_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "ml5, ml4 = LAPACK.syev_4.06e+07;", "4.06e+07;", "(Z18 W19 Z18^T) = tmp14;", "ml5, ml4 = LAPACK.syev!('V', 'L', ml4);", string(stamps[5]), ";", string(stamps[6]), '
'  ))
