...
function write_algorithm48_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "ml4 = qr_3.24e+07;", "3.24e+07;", "(Q16 R17) = tmp14;", "ml4 = qr!(ml4);", string(stamps[8]), ";", string(stamps[9]), '
'  ))
