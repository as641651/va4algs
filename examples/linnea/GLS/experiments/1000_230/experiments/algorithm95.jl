...
"""
    algorithm95(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm95(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.76e+08 FLOPs
...
function write_algorithm95_to_eventlog(io, id, stamps)
