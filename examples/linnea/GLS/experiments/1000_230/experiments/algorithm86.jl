...
function algorithm86(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # y: ml2, full, L2: ml1, lower_triangular, L15: ml4, lower_triangular, tmp219: ml3, full
    # tmp68 = (L2^-1 y)
    stime6= time()
    trsv!('L', 'N', 'N', ml1, ml2)

    # L2: ml1, lower_triangular, L15: ml4, lower_triangular, tmp219: ml3, full, tmp68: ml2, full
    # tmp71 = (L2^-T tmp68)
    stime7= time()
    trsv!('L', 'T', 'N', ml1, ml2)
...
function write_algorithm86_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "trsm_5.29e+07;", "5.29e+07;", "tmp219 = (L15^-1 tmp56);", "trsm!('L', 'L', 'N', 'N', 1.0, ml4, ml3);", string(stamps[6]), ";", string(stamps[7]), '
'  ))
    write( io, string(id, ";", "trsv_1e+06;", "1e+06;", "tmp68 = (L2^-1 y);", "trsv!('L', 'N', 'N', ml1, ml2);", string(stamps[7]), ";", string(stamps[8]), '
'  ))
