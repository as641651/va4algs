...
"""
    algorithm74(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm74(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.6e+08 FLOPs
...
function write_algorithm74_to_eventlog(io, id, stamps)
