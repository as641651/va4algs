...
"""
    algorithm90(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm90(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.76e+08 FLOPs
    ...
    # L2: ml1, lower_triangular, L15: ml4, lower_triangular, tmp68: ml2, full, tmp219: ml3, full
    # tmp71 = (L2^-T tmp68)
    stime7= time()
    trsv!('L', 'T', 'N', ml1, ml2)
...
function write_algorithm90_to_eventlog(io, id, stamps)
