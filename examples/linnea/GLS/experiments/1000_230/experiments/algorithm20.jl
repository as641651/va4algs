...
function algorithm20(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # b = tmp24
    stime10= time()
    return (ml4) ,(stime0,stime1,stime2,stime3,stime4,stime5,stime6,stime7,stime8,stime9,stime10,)
end

function write_algorithm20_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "LAPACK.potrf_4.06e+06;", "4.06e+06;", "(L15 L15^T) = tmp14;", "LAPACK.potrf!('L', ml5);", string(stamps[8]), ";", string(stamps[9]), '
'  ))
    write( io, string(id, ";", "trsv_5.29e+04;", "5.29e+04;", "tmp23 = (L15^-1 tmp21);", "trsv!('L', 'N', 'N', ml5, ml4);", string(stamps[9]), ";", string(stamps[10]), '
'  ))
    write( io, string(id, ";", "trsv_5.29e+04;", "5.29e+04;", "tmp24 = (L15^-T tmp23);", "trsv!('L', 'T', 'N', ml5, ml4);", string(stamps[10]), ";", string(stamps[11]), '
'  ))
end