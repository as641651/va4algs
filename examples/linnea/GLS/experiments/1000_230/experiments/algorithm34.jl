...
function algorithm34(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # y: ml2, full, tmp56: ml3, full, L2: ml1, lower_triangular, Q16: ml4, QRfact_Q, R17: ml4, QRfact_R
    # tmp68 = (L2^-1 y)
    stime5= time()
    trsv!('L', 'N', 'N', ml1, ml2)

    # tmp56: ml3, full, L2: ml1, lower_triangular, Q16: ml4, QRfact_Q, R17: ml4, QRfact_R, tmp68: ml2, full
    # tmp71 = (L2^-T tmp68)
    stime6= time()
    trsv!('L', 'T', 'N', ml1, ml2)
...
function write_algorithm34_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "ml4 = qr_3.24e+07;", "3.24e+07;", "(Q16 R17) = tmp14;", "ml4 = qr!(ml4);", string(stamps[5]), ";", string(stamps[6]), '
'  ))
