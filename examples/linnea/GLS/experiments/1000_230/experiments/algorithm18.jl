...
function write_algorithm18_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "LAPACK.potrf_4.06e+06;", "4.06e+06;", "(L15 L15^T) = tmp14;", "LAPACK.potrf!('L', ml4);", string(stamps[8]), ";", string(stamps[9]), '
'  ))
