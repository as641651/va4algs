...
"""
    algorithm52(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm52(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.59e+08 FLOPs
    ...
    # tmp68: ml2, full, tmp12: ml0, full, W19: ml4, diagonal_vector, Z18: ml3, full
...
function write_algorithm52_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "ml4, ml3 = LAPACK.syev_4.06e+07;", "4.06e+07;", "(Z18 W19 Z18^T) = tmp14;", "ml4, ml3 = LAPACK.syev!('V', 'L', ml3);", string(stamps[5]), ";", string(stamps[6]), '
'  ))
