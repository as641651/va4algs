...
"""
    algorithm53(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm53(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.59e+08 FLOPs
...
function write_algorithm53_to_eventlog(io, id, stamps)
