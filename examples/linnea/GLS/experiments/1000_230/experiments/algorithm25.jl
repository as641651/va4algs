...
function algorithm25(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # tmp12: ml0, full, Q16: ml3, QRfact_Q, R17: ml3, QRfact_R, tmp68: ml2, full
...
function write_algorithm25_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "ml3 = qr_3.24e+07;", "3.24e+07;", "(Q16 R17) = tmp14;", "ml3 = qr!(ml3);", string(stamps[4]), ";", string(stamps[5]), '
'  ))
