...
function write_algorithm26_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "ml3 = qr_3.24e+07;", "3.24e+07;", "(Q16 R17) = tmp14;", "ml3 = qr!(ml3);", string(stamps[6]), ";", string(stamps[7]), '
'  ))
