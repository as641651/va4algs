...
"""
    algorithm58(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm58(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.59e+08 FLOPs
...
function write_algorithm58_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "ml5, ml3 = LAPACK.syev_4.06e+07;", "4.06e+07;", "(Z18 W19 Z18^T) = tmp14;", "ml5, ml3 = LAPACK.syev!('V', 'L', ml3);", string(stamps[6]), ";", string(stamps[7]), '
'  ))
    write( io, string(id, ";", "gemv_1.06e+05;", "1.06e+05;", "tmp268 = (Z18^T tmp21);", "gemv!('T', 1.0, ml3, ml4, 0.0, ml6);", string(stamps[7]), ";", string(stamps[8]), '
'  ))
