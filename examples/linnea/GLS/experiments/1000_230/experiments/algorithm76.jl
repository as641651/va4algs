...
"""
    algorithm76(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm76(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.75e+08 FLOPs
    ...
    # L15: ml3, lower_triangular, tmp68: ml2, full, tmp70: ml0, full
...
function write_algorithm76_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "LAPACK.potrf_4.06e+06;", "4.06e+06;", "(L15 L15^T) = tmp14;", "LAPACK.potrf!('L', ml3);", string(stamps[4]), ";", string(stamps[5]), '
'  ))
    write( io, string(id, ";", "trsv_1e+06;", "1e+06;", "tmp68 = (L2^-1 y);", "trsv!('L', 'N', 'N', ml1, ml2);", string(stamps[5]), ";", string(stamps[6]), '
'  ))
    write( io, string(id, ";", "trsm_5.29e+07;", "5.29e+07;", "tmp70 = (tmp12 L15^-T);", "trsm!('R', 'L', 'T', 'N', 1.0, ml3, ml0);", string(stamps[6]), ";", string(stamps[7]), '
'  ))
    write( io, string(id, ";", "gemv_4.6e+05;", "4.6e+05;", "tmp23 = (tmp70^T tmp68);", "gemv!('T', 1.0, ml0, ml2, 0.0, ml4);", string(stamps[7]), ";", string(stamps[8]), '
'  ))
