...
function algorithm75(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # y: ml2, full, L2: ml1, lower_triangular, L15: ml3, lower_triangular, tmp70: ml0, full
    # tmp68 = (L2^-1 y)
    stime5= time()
    trsv!('L', 'N', 'N', ml1, ml2)

    # L15: ml3, lower_triangular, tmp70: ml0, full, tmp68: ml2, full
...
function write_algorithm75_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "trsm_5.29e+07;", "5.29e+07;", "tmp70 = (tmp12 L15^-T);", "trsm!('R', 'L', 'T', 'N', 1.0, ml3, ml0);", string(stamps[5]), ";", string(stamps[6]), '
'  ))
