...
"""
    algorithm92(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm92(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.76e+08 FLOPs
    ...
    # tmp71: ml2, full, L15: ml4, lower_triangular, tmp219: ml3, full
...
function write_algorithm92_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "LAPACK.potrf_4.06e+06;", "4.06e+06;", "(L15 L15^T) = tmp14;", "LAPACK.potrf!('L', ml4);", string(stamps[7]), ";", string(stamps[8]), '
'  ))
    write( io, string(id, ";", "trsm_5.29e+07;", "5.29e+07;", "tmp219 = (L15^-1 tmp56);", "trsm!('L', 'L', 'N', 'N', 1.0, ml4, ml3);", string(stamps[8]), ";", string(stamps[9]), '
'  ))
