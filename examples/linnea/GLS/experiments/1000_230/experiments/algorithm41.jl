...
function write_algorithm41_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "ml5 = qr_3.24e+07;", "3.24e+07;", "(Q16 R17) = tmp14;", "ml5 = qr!(ml5);", string(stamps[8]), ";", string(stamps[9]), '
'  ))
    write( io, string(id, ";", "gemv_1.06e+05;", "1.06e+05;", "tmp25 = (Q16^T tmp21);", "gemv!('T', 1.0, ml6, ml4, 0.0, ml7);", string(stamps[9]), ";", string(stamps[10]), '
'  ))
