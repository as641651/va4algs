...
"""
    algorithm91(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm91(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 6.76e+08 FLOPs
    ...
    # L2: ml1, lower_triangular, tmp68: ml2, full, L15: ml4, lower_triangular, tmp219: ml3, full
    # tmp71 = (L2^-T tmp68)
    stime7= time()
    trsv!('L', 'T', 'N', ml1, ml2)

    # L15: ml4, lower_triangular, tmp219: ml3, full, tmp71: ml2, full
...
function write_algorithm91_to_eventlog(io, id, stamps)
...
'  ))
    write( io, string(id, ";", "LAPACK.potrf_4.06e+06;", "4.06e+06;", "(L15 L15^T) = tmp14;", "LAPACK.potrf!('L', ml4);", string(stamps[6]), ";", string(stamps[7]), '
'  ))
    write( io, string(id, ";", "trsm_5.29e+07;", "5.29e+07;", "tmp219 = (L15^-1 tmp56);", "trsm!('L', 'L', 'N', 'N', 1.0, ml4, ml3);", string(stamps[7]), ";", string(stamps[8]), '
'  ))
    write( io, string(id, ";", "trsv_1e+06;", "1e+06;", "tmp71 = (L2^-T tmp68);", "trsv!('L', 'T', 'N', ml1, ml2);", string(stamps[8]), ";", string(stamps[9]), '
'  ))
    write( io, string(id, ";", "gemv_4.6e+05;", "4.6e+05;", "tmp23 = (tmp219 tmp71);", "gemv!('N', 1.0, ml3, ml2, 0.0, ml5);", string(stamps[9]), ";", string(stamps[10]), '
'  ))
